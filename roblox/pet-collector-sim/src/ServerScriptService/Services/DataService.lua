...
local PROFILE_STORE_NAME = "PetCollectorData_V1" -- Increment when changing data structure
...
local DEFAULT_DATA = {
	...
	-- Pet Collector specific
	Pets = {}, -- Array of pet instances
	EquippedPets = {}, -- {[slot] = petInstanceId}
	UnlockedWorlds = {1}, -- {1} = Starter Island unlocked
	CurrentWorld = 1,
	ActiveBoosts = {}, -- {BoostType = {ExpiresAt, Multiplier}}
	...
	Quests = {
		...
		LastDailyReset = 0,
		LastWeeklyReset = 0,
		Active = {}, -- Array of active quest data
		Completed = {}, -- {QuestId = CompletedAt}
		Progress = {}, -- {QuestId = {Objective1 = 2, Objective2 = 1}}
	},

	-- Story System (Adventure Story Obby)
	Story = {
		CurrentWorld = 1,
		CurrentLevel = 1,
		CompletedLevels = {}, -- {World1_Level1 = true, ...}
		UnlockedWorlds = {1}, -- {1}
		CollectedFragments = {}, -- {Fragment_W1_L1 = true, ...}
		NPCRelationships = {}, -- {Guide = 5, Merchant = 2, ...}
		DialogueHistory = {}, -- {DialogueId = SeenCount}
	},
