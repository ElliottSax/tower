...
-- ⚠️ REQUIRED BEFORE MONETIZATION TESTING:
-- Create these products on Roblox Creator Hub and update IDs:
--
-- GAME PASSES (7 total):
-- 1. VIPGamePassId = 0          -- TODO: VIP Pass (permanent 2x coins)
-- 2. PremiumPassId = 0           -- TODO: Battle Pass Premium
-- 3. ParticleEffectsPassId = 0   -- TODO: Particle Effects (149 Robux)
-- 4. EmotePackPassId = 0         -- TODO: Emote Pack (99 Robux)
-- 5. DoubleXPPassId = 0          -- TODO: Double XP (199 Robux)
-- 6. CheckpointSkipPassId = 0    -- TODO: Checkpoint Skip (79 Robux)
-- 7. SpeedDemonPassId = 0        -- TODO: Speed Demon (149 Robux)
--
-- DEVELOPER PRODUCTS (8 total):
-- Coin Packs:
-- 8. CoinPack500Id = 0           -- TODO: 500 Coins (49 Robux)
-- 9. CoinPack1500Id = 0          -- TODO: 1500 Coins (99 Robux)
-- 10. CoinPack4000Id = 0         -- TODO: 4000 Coins (199 Robux)
-- 11. CoinPack10000Id = 0        -- TODO: 10000 Coins (399 Robux)
-- XP Boosts:
-- 12. XPBoost30MinId = 0         -- TODO: 30min XP Boost (29 Robux)
-- 13. XPBoost1HourId = 0         -- TODO: 1hr XP Boost (49 Robux)
-- 14. XPBoost3HourId = 0         -- TODO: 3hr XP Boost (99 Robux)
-- Other:
-- 15. RespawnSkipId = 0          -- TODO: Respawn Skip (19 Robux)
