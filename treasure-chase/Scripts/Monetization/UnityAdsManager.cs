...
{
    /// <summary>
    /// Production-ready Unity Ads Manager for Treasure Chase.
    /// Handles rewarded videos and interstitial ads.
    ///
    /// Revenue Target: 70% of total ($0.021-$0.035 per DAU)
    /// Expected Impressions: 3-5 per session
    /// eCPM Target: $8-$12
    /// </summary>
    public class UnityAdsManager : MonoBehaviour, IUnityAdsInitializationListener, IUnityAdsLoadListener, IUnityAdsShowListener
    {
        ...
        [Tooltip("Minimum runs before showing interstitial")]
        public int runsBeforeInterstitial = 3;
        ...
        public void ShowInterstitialAd(Action onComplete = null)
        {
            ...
            if (runsSinceLastInterstitial < runsBeforeInterstitial)
            {
                ...
                DebugLog($"Not enough runs ({runsSinceLastInterstitial}/{runsBeforeInterstitial})");
                onComplete?.Invoke();
                return;
            }
        ...
        public bool IsInterstitialAdReady()
        {
            return isInitialized && interstitialAdLoaded &&
                   ...
                   (runsSinceLastInterstitial >= runsBeforeInterstitial);
        }
